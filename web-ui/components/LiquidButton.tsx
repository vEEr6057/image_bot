...
export default function LiquidButton({
    ...
    const baseStyles = "glass-button relative px-8 py-4 rounded-full font-bold tracking-widest text-sm uppercase flex items-center justify-center gap-3 group transition-all duration-500 backdrop-blur-md bg-white/5 hover:bg-white/10 border-2"
